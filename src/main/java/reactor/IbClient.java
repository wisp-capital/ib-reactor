...
import reactor.impl.IbReader;
import reactor.impl.IdGenerator;
import reactor.impl.Validators;
import reactor.impl.Wrapper;
import reactor.impl.cache.CacheRepository;
import reactor.impl.connection.ConnectionMonitor;
import reactor.impl.request.RequestRepository;
import reactor.params.AccountsSummaryParams;
import reactor.params.IbClientOptions;
...
public class IbClient implements AutoCloseable {
    ...
    private final Sinks.Many<IbLogRecord> logSubject =
        Sinks.many().unicast().onBackpressureBuffer();
    private final Sinks.Many<Boolean> connectionStatusSubject =
        Sinks.many().unicast().onBackpressureBuffer();
    ...
    /**
     * Generates new incremental request/order ID, if developer need to define it
     * explicitly.
     *
    ...
    public Mono<Void> connect(String ip, int port, int connId) {
        ...
        return Mono.create(emitter -> {
            ...
            connectionMonitor = new ConnectionMonitor(options.getConnectionDelay()) {
                ...
                @Override
                protected void onConnectStatusChange(Boolean connected) {
                    if (connected) {
                        emitter.success();
                    }
                    connectionStatusSubject.emitNext(connected, Sinks.EmitFailureHandler.FAIL_FAST);
                }
            };
        ...
        }).doOnError(e -> connectionMonitor.close()).then();
    }
     ...
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/managed_accounts.html">
     ...
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#af5ec205466b47cdab2cd17931b529e82">
     ...
     * @implNote After subscription, client sends snapshot with already existing
     *           positions. Then
     *           only updates will be send. To separate these two cases, special
     *           entry will be sent
     *           between them - {@link IbPosition#COMPLETE}
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/positions.html#position_request">
     *      TWS API: reqPositions</a>
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#ab2159a39733d8967928317524875aa62">
     ...
     *           between them - {@link IbPosition#COMPLETE}
     * @see <a
     *      href=https://interactivebrokers.github.io/tws-api/positions.html#position_multi>
     *      TWS API: reqPositionsMulti</a>
     * @see <a
     *      href=https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#ae919658c15bceba6b6cf2a1336d0acbf>
     ...
     * @see <a
     *      href=https://interactivebrokers.github.io/tws-api/delayed_data.html>TWS
     *      API: Delayed Streaming Data</a>
     */
     ...
     *      API: Delayed Streaming Data</a>
     * @see <a
     *      href=https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#a7a19258a3a2087c07c1c57b93f659b63>TWS
     *      API: reqMarketData</a>
     * @see <a
     *      href=https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#ae919658c15bceba6b6cf2a1336d0acbf>TWS
    ...
    /**
     * Requests venues for which market data is returned by
     * {@link IbClient#subscribeOnMarketDepth}
     * subscription.
     *
     * @return Flux with descriptions
     * @see <a
     *      href=https://interactivebrokers.github.io/tws-api/market_depth.html#reqmktdepthexchanges>
     *      TWS API: Market Maker or Exchange</a>
     * @see <a
     *      href=https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#a5c40b7bf20ba269530807b093dc51853>
     ...
     * @return Flux with PriceIncrement. Completes as soon all data will be
     *         received.
     * @see IbClient#setMarketDataType
     * @see <a
     *      href=https://interactivebrokers.github.io/tws-api/minimum_increment.html>TWS
     *      API: Minimum Price Increment</a>
     * @see <a
     *      href=https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#af4e8c23a0d1e480ce84320b9e6b525dd>TWS
     *      API: reqMarketRule</a>
     */
     ...
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#a8b1f37dfe964369f53d7f2d7ebcf17ca">
     *      TWS API: reqMarketDepth</a>
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#aee1213e04e1d22830e337c9735e995db">
     ...
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#af443a1cd993aee33ce67deb7bc39e484">
     ...
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#a9ba0dc47f80ff9e836a235a0dea791b3">
     *      TWS API: reqPnLMono</a>
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#accd383725ef440070775654a9ab4bf47">
     ...
     *      TWS API: reqPnL</a>
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#a5a805731fedd8f40130a51a459328572">
     *      TWS API: cancelPnL</a>
     ...
     * @implNote This information is the same as displayed in TWS Account Window.
     *           Data updates once per 3 min
     * @see <a href=
     ...
     *
     * <p>
     * As soon connection with TWS is lost or restored, respective status is
     * published
     *
     * @return Flux with booleans
     */
    public Flux<Boolean> connectionStatus() {
        return connectionStatusSubject.asFlux();
    }
     ...
     * @implNote Internally {@code ib-client} handles incoming TWS events according
     *           actual request type with severity
     *           detection, as soon TWS sends them in many cases as an errors,
     *           warning, or as a regular notifications.
     *           In normal work this function won't be needed, but it can be used if
     *           necessary to handle
     *           event that {@code ib-client} don't handle yet, or just for TWS
     *           events logging.
     * @see <a href=
     ...
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#ad1ecfd4fb31841ce5817e0c32f44b639">
     ...
     * @implNote TWS API requires every new order has to have unique and incremented
     *           {@link com.ib.client.Order#orderId}
     *           that is build based on "nextValidId" returned on API at connect.
     *           {@code ib-client} makes this step optional. If
     *           {@link com.ib.client.Order#orderId} is not assigned or zero,
     *           library generates ID by itself. In some cases Developer need to
     *           define ID explicitly, then he is able to
     *           generate new value with {@link #nextOrderId}
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/order_submission.html">
     *      TWS API: Placing Orders</a>
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/interfaceIBApi_1_1EWrapper.html#a09c07727efd297e438690ab42838d332">
    ...
    public Mono<IbOrder> placeOrder(Contract contract, Order order) {
        ...
        if (order.orderId() == 0) {
            log.info("Adding external id to order");
     ...
     *          Then library request IB for canceling and waits for respective
     *          status or error.
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/cancel_order.html">
     *      TWS API: Cancelling Orders</a>
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#adb0a6963779be4904439fb1f24a8cce8">
     ...
     *
     * @return Mono
     * @implNote To provide result, library uses a bit tangled logic to wait until
     *           all opened orders will be canceled.
     *           Some corner case are possible.
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/cancel_order.html">
     *      TWS API: Cancelling Orders</a>
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#a66ad7a4820c5be21ebde521d59a50053">
    ...
    public Mono<Void> cancelAll() {
        ...
        Flux<IbOrder> openedOrder = reqOpenOrders().filter(order -> !order.getLastStatus().isCanceled() &&
                !order.getLastStatus().isFilled() && !order.getLastStatus().isInactive());
        ...
        return openedOrder.buffer()
                .flatMap(Flux::fromIterable)
                .flatMap(order -> cancelAllAndWait.filter(status -> status.getOrderId() == order.getOrderId()).take(1))
                .then();
    }
     ...
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#aa2c9a012884dd53311a7a7c6a326306c">
    ...
    /**
     * Requests status updates about future orders placed from TWS. Can only be used
     * with client ID 0.
     *
     * @param autoBind if set to true, the newly created orders will be assigned an
     *                 API order ID and implicitly
     *                 associated with this client. If set to false, future orders
     *                 will not be.
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/open_orders.html#manually_submitted">
     *      TWS API: Manually submitted orders</a>
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#abe8e30367fff33b9a1171a4580029016">
    ...
    // trigger executions to arrive via subscribeonexecutionrpeort
    // only returns executions from today
    public Flux<IbExecutionReport> reqExecutions() {
        return requests.<IbExecutionReport>builder()
                .type(RequestRepository.Type.REQ_EXECUTIONS)
                .register(id -> socket.reqExecutions(10001, new ExecutionFilter()))
                .subscribe();
    }
     ...
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#ade440c6db838b548594981d800ea5ca9">
     ...
     * @return Flux with contract descriptions. Completes as soon TWS sends all
     *         data.
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/matching_symbols.html">
     *      TWS API: Stock Contract Search</a>
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#aa0bff193c5cbaa73e89dccdd0f027195">
     ...
     *
     * @param contract IB contract
     * @param from     Period start. Uses TWS timezone specified at login. Cannot be
     *                 used with "<strong>to</strong>"
     * @param to       Period end. Uses TWS timezone specified at login. Cannot be
     *                 used with "<strong>from</strong>"
     ...
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/classIBApi_1_1EClient.html#a99dbcf80c99b8f262a524de64b2f9c1e">
     *      TWS API: reqHistoricalTicks</a>
     * @see #reqHistoricalBidAsks
     * @see #reqHistoricalTrades
     */
    public Flux<HistoricalTick> reqHistoricalMidpoints(
            Contract contract, LocalDateTime from, LocalDateTime to, Integer limit) {
        return reqHistoricalTicks(contract,
                from,
                to,
                limit,
                RequestRepository.Type.REQ_HISTORICAL_MIDPOINT_TICK,
                "MIDPOINT");
    }
     ...
     * @see #reqHistoricalTrades
     */
    public Flux<HistoricalTickBidAsk> reqHistoricalBidAsks(
            Contract contract, LocalDateTime from, LocalDateTime to, Integer limit) {
        return reqHistoricalTicks(contract,
                from,
                to,
                limit,
                RequestRepository.Type.REQ_HISTORICAL_BID_ASK_TICK,
                "BID_ASK");
    }
     ...
     * @param limit    Number of distinct data points. Max is 1000 per request.
     * @return Flux with historical data. Completes as soon IB sends all data.
     * @apiNote Note that IB doesn't return trades for Forex contracts, i.e. for
     *          contracts with
     *          {@link Contract#secType()} is {@link Types.SecType#CASH}. Calling
     *          respective IB API method
     *          {@link EClient#reqHistoricalTicks} with parameter
     *          {@code whatToShow=TRADES} and Forex contract,
     *          it was expected that {@link EWrapper#historicalTicksLast} callback
     *          will be called,
     *          as it described in documentation. Instead
     *          {@link EWrapper#historicalTicks}callback is called,
     *          the same way as if you call {@link #reqHistoricalMidpoints} with
     *          {@code whatToShow=MIDPOINT}.
     *          For stocks this request behaves as expected. IB support told "it's a
     *          special case for Forex".
     *          <p>
     *          So to make library API consistent, all Forex contracts for this
     *          method are forbidden. You still able
     ...
     * @see #reqHistoricalBidAsks
     */
    public Flux<HistoricalTickLast> reqHistoricalTrades(
            Contract contract, LocalDateTime from, LocalDateTime to, Integer limit) {

        if (contract.secType() == Types.SecType.CASH) {
            throw new IllegalArgumentException(
                    "IB doesn't return historical trades for Forex contracts");
        }
        ...
        return reqHistoricalTicks(contract,
                ...
                to,
                limit,
                RequestRepository.Type.REQ_HISTORICAL_TRADE,
                "TRADES");
    }
     ...
     * @param duration     The amount of time to go back from the request's given
     *                     end date and time.
     * @param durationUnit <strong>duration</strong> unit
     * @param size         Valid Bar Sizes
     * @param type         The type of data to retrieve
     * @param tradingHours Whether ({@link TradingHours#Within}) or not
     *                     ({@link TradingHours#Outside}) to retrieve
     *                     data generated only within Regular Trading Hours
     * @return Flux with the bars. Completes as soon all data per period will be
     *         received.
     *         Can emit errors: IbExceptions.NoPermissions on "No market data
     *         permissions" message,
     ...
     */
    public Flux<IbBar> reqHistoricalData(
            Contract contract,
        ...
        log.debug(
                "Requesting bars: contract={}, endDateTime={}, duration={} {}, size={}, type={}, hours={}",
    ...
    /**
     * Request for historical bars (aka candles) and subscription for actual
     * unfinished candle.
     *
     * @param contract     IB contract
     * @param duration     The amount of time to go back from the request's given
     ...
     * @param type         The type of data to retrieve
     * @param tradingHours Whether ({@link IbClient.TradingHours#Within}) or not
     *                     ({@link IbClient.TradingHours#Outside})
     *                     to retrieve
     *                     data generated only within Regular Trading Hours
     * @return Flux with the bars. Never completes. Flow is: 1st historical bars are
     *         goes, then one
     *         {@link IbBar#COMPLETE}, and then constant updates of actual candle.
     *         Can emit errors:
     *         IbExceptions.NoPermissions on "No market data permissions" message,
     *         Exception - for possible unknown messages
     * @implNote Function is similar to {@link #reqHistoricalData}, it got all
     *           historical data as
     *           {@link #reqHistoricalData} do, but then emits
     *           {@link IbBar#COMPLETE} as a separator,
     ...
     */
    public Flux<IbBar> subscribeOnHistoricalData(
            Contract contract,
            int duration,
            DurationUnit durationUnit,
            BarSize size,
     ...
     *
     * @return Flux with {@link IbExecutionReport}. Never completes. Object contains
     *         wrapped data from
     *         both related callbacks
     *         {@link Wrapper#execDetails(int, com.ib.client.Contract, com.ib.client.Execution)}
     *         and
     ...
     * @see <a href=
     *      "https://interactivebrokers.github.io/tws-api/interfaceIBApi_1_1EWrapper.html#a7ebfc18d5d03189ab5bf895db4a1a204">
    ...
    private <T> Flux<T> reqHistoricalTicks(
            Contract contract,
            LocalDateTime from,
            LocalDateTime to,
            Integer limit,
        ...
        return requests.<List<T>>builder().type(type).register(id -> socket.reqHistoricalTicks(id,
                contract,
                ...
                0,
                true,
                null)).subscribe().flatMap(Flux::fromIterable);
    }
    ...
    public enum AccountSummaryTags {
        ...
        EquityWithLoanValue, // Forms the basis for determining whether a client has the necessary assets to
                             // either
        ...
        LookAheadInitMarginReq, // Initial Margin requirement of whole portfolio as of next period's margin
                                // change
        LookAheadMaintMarginReq, // Maintenance Margin requirement of whole portfolio as of next period's margin
                                 // change
        LookAheadAvailableFunds, // This value reflects your available funds at the next margin change
        LookAheadExcessLiquidity, // This value reflects your excess liquidity at the next margin change
        HighestSeverity, // A measure of how close the account is to liquidation
        DayTradesRemaining, // The Number of Open/Close trades a user could put on before Pattern Day
                            // Trading is
