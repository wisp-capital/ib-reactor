...
public class AccountsSummaryParams {
    ...
    private EnumSet<IbClient.AccountSummaryTags> tags =
        EnumSet.noneOf(IbClient.AccountSummaryTags.class);
    ...
    public String buildTags() {
        return Stream.concat(tags.stream().map(Enum::name), Stream.of(ledger))
